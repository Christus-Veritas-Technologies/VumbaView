  ...
  return (
    <>
      <PageHero
        ...
        description="Since 1987, VumbaView Academy has grown from three classrooms into a full ECD-to-A-Level community — without losing sight of why it was founded."
