...
import { CreditCard, FileBarChart2, LayoutDashboard, Settings, TrendingDown, Users } from "lucide-react-native";
    ...
    >
      ...
      <Tabs.Screen
        ...
        options={{
          title: "Reports",
          headerShown: false,
          tabBarIcon: ({ color, size }) => <FileBarChart2 color={color} size={size} />,
        }}
      />
      <Tabs.Screen
        name="settings"
