      ...
      >
        ...
        {showClose ? (
          <DialogClose
            ...
            className="absolute top-4 right-4 rounded-none opacity-70 outline-none transition-opacity hover:opacity-100 focus-visible:ring-1 focus-visible:ring-ring/50"
            aria-label="Close"
          >
